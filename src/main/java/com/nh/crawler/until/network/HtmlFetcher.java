...
public class HtmlFetcher {
	...
	public String getHtml(String url, String encodingType, int sokTimeout) throws Exception {
		logger.info("url  " + url);
		...
		try {
			...
			if (statusCode == 200 || statusCode == 201 || statusCode == 202) {
				logger.debug("HTTP status code  " + statusCode
						+ " OK,Proceeding... ");
				htmlResult = getHtmlSource(response, encodingType);
	...
	public String getAbsoluteUrl(String url, String encodingType, int socTimeOut) throws Exception {
		...
		try {
			...
			if (statusCode == 404) {
				...
				htmlContent = getHtmlSource(response, encodingType);
				if (htmlContent != null) {
					...
					if (finalUrl != null) {
						...
						getAbsoluteUrl(finalUrl, encodingType, socTimeOut);
					} else {
				...
				getAbsoluteUrl(redirectedUrl, encodingType, socTimeOut);
